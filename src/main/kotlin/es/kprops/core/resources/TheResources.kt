...
private lateinit var chips: Chips
    ...
    fun getChecksenvironment(): Chips {
        if (!this::chips.isInitialized) {
            this.chips = readJsonResources_checksenvironment("checksenvironment.json")
        }
        return this.chips
    }
}